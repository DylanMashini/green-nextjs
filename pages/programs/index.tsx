      ...
      <div className={`${styles["content"]} ${mobile ? styles["mobile"] : ""}`}>
        ...
        >
          <div className={styles["item"]}>
            ...
            >
              Our goal is to reduce over 100,000 metric tons of CO2 equivalent
              by 2030 through empowering Cobb County to install smart
              thermostats, rooftop solar, and shifting energy use to off-peak
              times.
            </h3>
          </div>
          <div className={styles["item"]}>
            ...
            >
              Our goal is to reduce over 300,000 metric tons CO2 equivalent by
              2030 through increased access to recycling infrastructure in Cobb
              County businesses, sporting and entertainment venues.{" "}
            </h3>
          </div>
          <div className={styles["item"]}>
            <h1
